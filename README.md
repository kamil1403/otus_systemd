...
• Доработать unit-файл Nginx (nginx.service) для запуска нескольких инстансов. Результат см. на скриншоте 🖼️ ["nginx"](https://github.com/kamil1403/otus_systemd/blob/main/screenshots/nginx.png)     
